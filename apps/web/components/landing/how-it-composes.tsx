...
const steps = [
  {
    ...
    body: 'Give your form a title, write an optional description, and set a custom URL slug for sharing.',
    icon: Pencil,
  ...
  },
  {
    ...
    body: 'Add fields like text, number, email, dropdowns, ratings, and dates. Reorder them using directional buttons and define custom conditional visibility rules.',
    icon: Layers,
  ...
  },
  {
    ...
    body: 'Choose from 5 pre-built animated themes, configure passwords, set expiry dates or response limits, link webhook URLs, and write a thank-you note.',
    icon: Settings2,
  ...
  },
  {
    ...
    body: 'Publish your form to freeze a snapshot, then share the link. Watch submissions accumulate in your dashboard and download responses in one click as a CSV.',
    icon: Send,
